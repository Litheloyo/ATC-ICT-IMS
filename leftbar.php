            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="viewitem.php"><i class="fa fa-laptop"></i> <span>Item</span></a>
                        </li>
                        
                          <li>
                            <a href=""><i class="fa fa-calendar"></i> <span>Borrower</span></a>
                        </li>
                        
              

                          <li>
                            <a href="rooms.php"><i class="fa fa-building"></i> <span>Room</span></a>
                        </li>
                        
                        
                          <li>
                            <a href="equipment.php"><i class="fa fa-calendar"></i> <span>Invetory</span></a>
                        </li>
                        
                          <li>
                            <a href="viewuser.php"><i class="fa fa-user"></i> <span>User</span></a>
                        </li>
